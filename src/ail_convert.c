...
/*	{E_AIL_PROP_X_SLP_BASELAYOUTWIDTH_INT, AIL_PROP_X_SLP_BASELAYOUTHEIGHT_INT}, */
/*	{E_AIL_PROP_X_SLP_BASELAYOUTHEIGHT_INT, AIL_PROP_X_SLP_BASELAYOUTHEIGHT_INT} */
};
...
/*	{E_AIL_PROP_X_SLP_EVENTNOTIFICATIONSETTING_BOOL, AIL_PROP_X_SLP_EVENTNOTIFICATIONSETTING_BOOL} */
};
