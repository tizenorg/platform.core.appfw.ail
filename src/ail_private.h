...
typedef enum {
	...
	E_AIL_PROP_STR_MAX = E_AIL_PROP_X_SLP_EXE_PATH,
} ail_prop_str_e;
...
typedef enum {
	...
	E_AIL_PROP_X_SLP_BASELAYOUTWIDTH_INT = E_AIL_PROP_INT_MIN,
	E_AIL_PROP_X_SLP_BASELAYOUTHEIGHT_INT,
	E_AIL_PROP_INT_MAX = E_AIL_PROP_X_SLP_BASELAYOUTHEIGHT_INT,
} ail_prop_int_e;
...
typedef enum {
	...
	E_AIL_PROP_X_SLP_EVENTNOTIFICATIONSETTING_BOOL,
	E_AIL_PROP_BOOL_MAX = E_AIL_PROP_X_SLP_EVENTNOTIFICATIONSETTING_BOOL,
} ail_prop_bool_e;
